...
void Laborator3::Update(float deltaTimeSeconds)
{
	...
	//rotating square
	modelMatrix *= Transform2D::Translate(sq_side / 2.f, sq_side / 2.f);
	...
	//pulsing square
	modelMatrix *= Transform2D::Translate(sq_side / 2.f, sq_side / 2.f);
	modelMatrix *= Transform2D::Scale(2 + sin(scaleX), 2 + sin(scaleY));
	modelMatrix *= Transform2D::Translate(-sq_side / 2.f, -sq_side / 2.f);
	...
	if (move_r)
	{
		translateX += deltaTimeSeconds * res_x * 0.15f;
		modelMatrix *= Transform2D::Translate(translateX, translateY);

		if (translateX > res_x * 0.15)
		{
			move_r = false;
		}
	}
	...
	{
		translateX -= deltaTimeSeconds * 0.15f * res_x;
		modelMatrix *= Transform2D::Translate(translateX, translateY);
